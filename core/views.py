...
def clean_text_content(text):
    ...
    text = text.replace('â€™', "'") # Right single quotation mark (apostrophe)
    ...
    if request.method == 'POST':
        try:
            ...
            if any(phrase in user_message.lower() for phrase in creator_triggers):
                ai_response = "I was created by Srinivas, the developer behind Fusion AI — a passionate builder of smart career tools designed to empower job seekers like you."
            ...
            if not ai_response or not ai_response.strip():
                ai_response = "Sorry, I couldn’t generate a proper response. Please try again."
...
async def faq_view(request):
    ...
    faqs = [
        ...
        {"question": " How is the optimized resume different?", "answer": "It’s made ATS-friendly with improved formatting, keyword alignment, and clarity."},
        ...
        {"question": " What if I don’t have a job description?", "answer": "You can still get resume suggestions and practice generic questions."},
